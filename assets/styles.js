...
tabTogglers.forEach(function (toggler) {
    toggler.addEventListener("click", function (e) {
        ...
        for (let i = 0; i < tabContents.children.length; i++) {
            tabTogglers[i].parentElement.classList.remove("border-b","border-red-600","border-red-400","text-red-600","dark:text-red-600", "opacity-100");
        ...
        e.target.parentElement.classList.add("border-b","border-red-600","border-red-400","text-red-600","dark:text-red-600", "opacity-100");
    });
});
